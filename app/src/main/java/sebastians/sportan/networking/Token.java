...
public class Token implements org.apache.thrift.TBase<Token, Token._Fields>, java.io.Serializable, Cloneable, Comparable<Token> {
  ...
  private static final org.apache.thrift.protocol.TField VALIDITY_FIELD_DESC = new org.apache.thrift.protocol.TField("validity", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  private static final int __VALIDITY_ISSET_ID = 0;
  ...
  public Token setValidity(long validity) {
    this.validity = validity;
    setValidityIsSet(true);
    return this;
  }
  ...
  public void unsetValidity() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __VALIDITY_ISSET_ID);
  }

  /** Returns true if field validity is set (has been assigned a value) and false otherwise */
  public boolean isSetValidity() {
    return EncodingUtils.testBit(__isset_bitfield, __VALIDITY_ISSET_ID);
  }

  public void setValidityIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __VALIDITY_ISSET_ID, value);
  }
  ...
  public boolean equals(Token that) {
    ...
    boolean this_present_validity = true;
    boolean that_present_validity = true;
    if (this_present_validity || that_present_validity) {
      if (!(this_present_validity && that_present_validity))
        return false;
      if (this.validity != that.validity)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_validity = true;
    list.add(present_validity);
    if (present_validity)
      list.add(validity);
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'validity' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TokenStandardScheme extends StandardScheme<Token> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Token struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetValidity()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'validity' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Token struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.validity);
      oprot.writeFieldEnd();
