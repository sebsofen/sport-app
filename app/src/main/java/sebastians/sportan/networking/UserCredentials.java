...
public class UserCredentials implements org.apache.thrift.TBase<UserCredentials, UserCredentials._Fields>, java.io.Serializable, Cloneable, Comparable<UserCredentials> {
  ...
  private static final org.apache.thrift.protocol.TField PASSWORDHASH_FIELD_DESC = new org.apache.thrift.protocol.TField("passwordhash", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public String passwordhash; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    IDENTIFIER((short)1, "identifier"),
    PASSWORDHASH((short)2, "passwordhash");
  ...
  private static final _Fields optionals[] = {_Fields.PASSWORDHASH};
  ...
  static {
    ...
    tmpMap.put(_Fields.PASSWORDHASH, new org.apache.thrift.meta_data.FieldMetaData("passwordhash", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public UserCredentials setIdentifier(String identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  public void unsetPasswordhash() {
    this.passwordhash = null;
  }

  /** Returns true if field passwordhash is set (has been assigned a value) and false otherwise */
  public boolean isSetPasswordhash() {
    return this.passwordhash != null;
  }

  public void setPasswordhashIsSet(boolean value) {
    if (!value) {
      this.passwordhash = null;
    }
  }
  ...
  public boolean equals(UserCredentials that) {
    ...
    boolean this_present_passwordhash = true && this.isSetPasswordhash();
    boolean that_present_passwordhash = true && that.isSetPasswordhash();
    if (this_present_passwordhash || that_present_passwordhash) {
      if (!(this_present_passwordhash && that_present_passwordhash))
        return false;
      if (!this.passwordhash.equals(that.passwordhash))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_passwordhash = true && (isSetPasswordhash());
    list.add(present_passwordhash);
    if (present_passwordhash)
  ...
  public int compareTo(UserCredentials other) {
    ...
    lastComparison = Boolean.valueOf(isSetPasswordhash()).compareTo(other.isSetPasswordhash());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPasswordhash()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.passwordhash, other.passwordhash);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class UserCredentialsStandardScheme extends StandardScheme<UserCredentials> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserCredentials struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PASSWORDHASH
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.passwordhash = iprot.readString();
              struct.setPasswordhashIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserCredentials struct) throws org.apache.thrift.TException {
      ...
      if (struct.passwordhash != null) {
        if (struct.isSetPasswordhash()) {
          oprot.writeFieldBegin(PASSWORDHASH_FIELD_DESC);
          oprot.writeString(struct.passwordhash);
          oprot.writeFieldEnd();
        }
      }
