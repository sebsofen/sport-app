              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Sport>(_list24.size);
                  Sport _elem25;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllSports_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Sport _iter27 : struct.success)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Sport _iter28 : struct.success)
            {
              _iter28.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Sport>(_list29.size);
            Sport _elem30;
